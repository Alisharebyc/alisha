...
Console.WriteLine("Эта программа выводит название дней недели по заданному номеру.\n Введите цифру от 0 до 7");
...
//else Сonsole.WriteLine("Это не цифра от 0 до 7");
...
switch(day)
{
    ...
    default: Console.WriteLine("Это не цифраа от 0 до 7"); break;
}
